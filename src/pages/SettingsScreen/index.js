...
const SettingsScreen = (props) => {
  ...
  useEffect(() => {
    setNome(props.nome);
    setDataNasc(props.dataNasc);
    setEmail(props.email);
    setIdAluno(props.idAluno);
    setCurso(props.curso);
    setSenha(props.senha);
    setConfirmarSenha(props.senha);
  }, []);
...
const mapStateToProps = (state) => {
  return {
    ...
    dataNasc: state.userReducer.dataNasc,
...
const mapDispatchToProps = (dispatch) => {
  return {
    setUser: ([nome, dataNasc, email, idAluno, curso, senha]) => dispatch({ type: 'ALTER_USER', payload: { nome, dataNasc, email, idAluno, curso, senha } })
  };
}
